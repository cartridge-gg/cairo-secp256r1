...
from src.secp256r1 import P0, P1, P2, GX0, GX1, GX2, GY0, GY1, GY2, N0, N1, N2, A0, A1, A2, SECP_REM

from src.ecdsa import verify_ecdsa

@view
func test_verify_secp256r1{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}():
    let gen_pt = EcPoint(
        BigInt3(GX0, GX1, GX2),
        BigInt3(GY0, GY1, GY2))
