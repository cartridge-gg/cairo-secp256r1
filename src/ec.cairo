...
func compute_doubling_slope{range_check_ptr}(pt: EcPoint) -> (slope: BigInt3) {
    ...
    let y_2 = UnreducedBigInt3(d0=pt.y.d0 * 2, d1=pt.y.d1 * 2, d2=pt.y.d2 * 2);
...
func compute_slope{range_check_ptr}(pt0: EcPoint, pt1: EcPoint) -> (slope: BigInt3) {
    ...
    let y_diff = UnreducedBigInt5(
        d0=pt0.y.d0 - pt1.y.d0, d1=pt0.y.d1 - pt1.y.d1, d2=pt0.y.d2 - pt1.y.d2, d3=0, d4=0
    );
...
func verify_point{range_check_ptr}(pt: EcPoint) {
    ...
    // check left == right
    let gky_diff = BigInt3(d0=GY0 - pt.y.d0, d1=GY1 - pt.y.d1, d2=GY2 - pt.y.d2);
    let gky_sum = BigInt3(d0=GY0 + pt.y.d0, d1=GY1 + pt.y.d1, d2=GY2 + pt.y.d2);
    let gkx_diff = BigInt3(d0=GX0 - pt.x.d0, d1=GX1 - pt.x.d1, d2=GX2 - pt.x.d2);
