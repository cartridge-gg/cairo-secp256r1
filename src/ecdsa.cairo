...
func verify_ecdsa{range_check_ptr}(
        public_key_pt : EcPoint, gen_pt : EcPoint, n : BigInt3, a : BigInt3, p : BigInt3, secp_rem : felt, msg_hash : BigInt3, r : BigInt3, s : BigInt3):
    alloc_locals
    verify_point(public_key_pt, gen_pt, a, p)
    ...
    let (gen_u1) = ec_mul(gen_pt, u1, a, p, secp_rem)
